...
SELECT * FROM (
    ...
    FROM 
        ...
        INNER JOIN posts AS p
        ON c.parent = p.id
    WHERE c.body LIKE '%<@{$values['user']}>%' AND c.author != {$values['user']} AND p.author != {$values['user']}
